# Martial Consequences Card Bible

## Review Policy

Each pack grows in blocks of ten cards. At 30 cards, it receives a full mechanical review. Similar cards may intentionally remain during early development and are corrected during that review.

## Martial Attack Fumbles — Block 1
...
| MAF-017 | Driven Aside | Moderate | Manual | Target chooses a safe adjacent space for the source |
| MAF-018 | Lost Ground | Moderate | Manual | Source Steps directly away from the target |
