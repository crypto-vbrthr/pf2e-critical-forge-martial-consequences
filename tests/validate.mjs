...
assert.equal(openingById.get("mo-024-instant-coordination").weight, 2);
...
console.log("PF2E Critical Forge: Martial Consequences 0.3.2 structural validation passed.");
