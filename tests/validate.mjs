...
assert.equal(disabled[3].cards.length, 20);
...
assert.equal(momentumCards.length, 20);
...
console.log("PF2E Critical Forge: Martial Consequences 0.4.1 structural validation passed.");
