...
assert.equal(registeredPackBatches[0].packs[3].cards.length, 30);
...
console.log("PF2E Critical Forge: Martial Consequences 0.4.2 startup-order validation passed.");
