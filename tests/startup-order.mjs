...
assert.equal(registeredPackBatches[0].packs[1].cards.length, 10);
...
console.log("PF2E Critical Forge: Martial Consequences 0.2.0 startup-order validation passed.");
